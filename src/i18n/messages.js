export const MESSAGE_KEY = Object.freeze({
  ...
  CONTENT_SHARES_LOAD_FAILED: "CONTENT_SHARES_LOAD_FAILED",
  CONTENT_SHARES_MARK_READ_FAILED: "CONTENT_SHARES_MARK_READ_FAILED",
  CONTENT_SHARE_UNAVAILABLE: "CONTENT_SHARE_UNAVAILABLE",
  CONTENT_SHARE_SENT: "CONTENT_SHARE_SENT",
...
const TURKISH_MESSAGES = Object.freeze({
  ...
  [MESSAGE_KEY.CONTENT_SHARES_LOAD_FAILED]:
    "Paylaşımlar şu an yüklenemedi.",
  [MESSAGE_KEY.CONTENT_SHARES_MARK_READ_FAILED]:
    "Paylaşımlar okundu işaretlenemedi.",
  [MESSAGE_KEY.CONTENT_SHARE_UNAVAILABLE]:
    "Bu içerik artık kullanılamıyor veya erişime kapalı.",
  [MESSAGE_KEY.CONTENT_SHARE_SENT]:
    "İçerik Bizim Mekanlar içinde gönderildi.",
